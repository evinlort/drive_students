...
class AdminController extends Controller
{
    ...
    public function studentReport(Request $request)
    {
        ...
        $data['lessons'] = Lesson::where('user_id', $data['user']->id)->whereBetween('date', [$this->date_range_start, $this->date_range_end])->get();
    ...
    public function downloadCSV(Request $request)
    {
        $this->get_dates_range();
        $data['user'] = User::where('identity', $request->id)->first();
        $lessons = Lesson::where('user_id', $data['user']->id)->whereBetween('date', [$this->date_range_start, $this->date_range_end])->get();
